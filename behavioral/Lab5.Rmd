...
- The codebook to understand what the data means is available on Moodle here: [moodle.smith.edu/mod/resource/view.php?id=233897](https://moodle.smith.edu/mod/resource/view.php?id=233897)  
...
```{r import Marseille}
Marseille <- read_table("../more/MARS.txt", col_names = FALSE)
```
...
DO NOT run the code below yourselves (the sample size is huge and I don't know how powerful your laptops are), just look at the plot. What does it suggest?  
```{r AllFishPlot}
Mars %>% 
