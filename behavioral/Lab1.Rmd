...
- using code chunks to perform an activity
- seeing the output of the code chunk, and 
- commenting on the code and its ouptut in prose between the code chunks. 
...
* You will lightly edit the top of the page between the `---` lines (you'll only change the title)
* Then, you'll mostly edit after that in the *body* of the document
...
- Each of the sections should include a bulleted list of jobs/degree(s)
