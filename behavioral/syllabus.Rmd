...
- Michelle Baddeley, 2017, *Behavioural Economics: A Very Short Introduction*, Oxford University Press, Oxford, UK.

Supplementary:
We use three supplementary texts in the course. They are all available free of charge online. 
...
- Bowles, Foley and Halliday, *Microeconomics: Competition, Conflict and Coordination* is a forthcoming textbook in intermediate microeconomics. You can access the pdf of the draft of the book on Moodle. I will refer to it mostly to remind you of ideas you should remember from intermediate microeconomics. 
...
1. If you do not have one, create a LinkedIn account with your Smith email address (be sure to use your smith.edu email address). 
2. Create an account at [Datacamp.com](https://datacamp.com) connected to your LinkedIn account. 
3. I will add you to the course on [Datacamp.com](https://datacamp.com) and you will be able to complete exercises there. 
...
| 10/17-10/19  | Week 7 | Learning & Info |  BE Ch. 5 | Experiment   |  - |
| 10/24-10/26  |  Week 8 | Group Interactions |  BE Ch. 6 | Lab 5   | ER3 (T); Prop Pres (Th) |
...
| 11/14-16 | Week 11 | Social Preferences |   BE Ch. 7 |  Experiment   | -  |
| 11/21 | Week 12 | Happiness & Utility  |  BE Ch. 10 |  Lab 8   | ER4 |
| 11/22-11/26 | - | Thanksgiving Break | - | - | - |
| 11/28-30  | Week 13 | Policy  |  BE Ch. 11 |  Lab 9  | - |
| 11/1-3  | Week 14 | Policy |  BE Ch. 11 | - | - |
| 12/8-10  | Week 15 | Final Presentations |  |  - | - |
...
##Moodle & Website
In general, I will use my site, simondhalliday.github.io/eco254 for content for ECO254. We also have a moodle site where the lecture capture software will automatically send lecture recordings and I will put copies of files that we use in the course. 
...
The draft protocol for R is available here: [simondhalliday.github.io/eco254/fall_2015/TIER/tier_protocol_r](https://simondhalliday.github.io/eco254/fall_2015/TIER/tier_protocol_r). 
...
##Stats Prep & Extra Credit for Spinelli Center Workshops
In the first week of ECO254, you will need to complete a knowledge survey on Moodle. Your answers on the knowlege survey will provide me and Dr. McCune some insight into what you would want to have revised by the Spinelli Center. Please access the knowledge survey through [Moodle](https://moodle.smith.edu/mod/questionnaire/view.php?id=17318). 

Ms. Maria Delfin-Auza is the statistics consultant at the Spinelli Center. She has a BA in Economics and a BA in Math & Stats. She is currently completing two MA degrees (one in public policy & another in resource economics). She can coach you on the use of Excel and R. Maria will run the workshops at the Spinelli Center. 

The Spinelli Center will give me a list of the people who attend the revision workshops and I will give you extra credit if you do attend the workshops. 
...
##Some notes on my goals and my learning

- It is the second time I am teaching ECO254. 
- I love the ideas in behavioral economics. I love to talk about them, think about the out loud, and to debate their relevance.
