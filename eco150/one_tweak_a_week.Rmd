...
```{marginfigure}
**A note on safety** Please be aware that you should be careful if you're meeting a total stranger. If you're meeting a fellow Smithie through local networks, that's great. But if you're meeting someone you don't know, then maybe take a friend or be sure to meet in a public place. While most people on the planet are kind and caring, that doesn't mean we shouldn’t remain aware and conscious of our context. With that in mind, please be careful if you're meeting a total
```
