...
page-layout: article
description: 'Plotting data from the Survey of Income and Program Participation (2013)'
categories:
  - 'inequality'
  - 'race'
  - 'USA'
...
![](/img/blog_images/race-wealth_files/figure-markdown_github-ascii_identifiers/netwealth-plot-1.png)
...
![](/img/blog_images/race-wealth_files/figure-markdown_github-ascii_identifiers/stacked-wealth-plot-1.png)
