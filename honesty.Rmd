...
- people have a *preference* for honesty (or against guilty or lying)
...
- people have a utility function with standard properties
    ...
    - extensive margin: a cost to lying at all
    - intensive margin: a cost in *size* of lie 
...
Dannenberg and Khachatryan (2017, working paper) 
 ...
 - replicate FFH + competition + group decisoins
 - one-shot competitive choice either with one other participant, as a member of a team of three against another team of three, or as a single or team of three against a single or team of three (2 by 2 treatment design). 
The authors provide evidence suggesting that subjects who compete one-on-one are no more dishonest than subjects who do not compete when making their choices. 
On the contrary, teams of three against teams of three are more likely to report higher numbers (are more dishonest). 
