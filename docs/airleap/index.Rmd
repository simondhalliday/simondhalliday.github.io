...
author: "Dvorak, Halliday (that's me), O'Hara and Swoboda"
date: "AIRLEAP, 13 October 2017"
...
We highlight 5 types of efficiency in empirical courses

>- Efficiency in package suites

>- Efficiency in reproducibility

>- Efficiency in workflow

>- Efficiency in instruction/assessment 

>- Efficiency in package cost
...
```{r, out.width = "200px", fig.cap = "St. Lawrence U.", fig.align = "center"}
...
## Gaps? 
- Where is the "one-stop-shop" for reproducible empirical research? 
- So, gap of what package suite to teach to maximize efficiency.
- Pace G & S ('14) hard to scale the capabilities they expect
- Second gap: how to teach high-level skills without expecting initial high level capabilities? Or, to teach high-level skills with minimum cost? 
- Third gap? What workflows to teach to students? What set of practices?
...
Senior Seminar in Environmental Economics
