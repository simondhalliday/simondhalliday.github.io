...
>- Broad and used in industry (unlike Stata)
...
>- Python and Jupyter Notebooks 
    ...
    + good for theory & visualization
    + plays well with R & R Studio (`reticulated Python`)
...
- Students can struggle with basic computing (working directory, etc.); but autocomplete helps
