...
knitr::include_graphics('BFHMicro_production_intro.jpg')
```
---> 
...
We use calculus in the book, but almost all of the calculus is contained in boxes. 
